...
public class SpellOfIceblast extends Spell {
    {
        name = "Spell of Iceblast";
//        mp_cost = 1;
//        image = ItemSpriteSheet.SPELL_ICE2;
//        minlevel = 1;
...
//        if (ch != null) {
//
//            int damage= Random.Int(level*2, level * level + 10);
//            if (checkFam(curUser)){ damage *= (int) 4f;}
//            ch.damage(damage, this);
//
//            if (ch == curUser && !ch.isAlive()) {
//                Dungeon.fail(Utils.format(ResultDescriptions.ITEM, name));
//                GLog.n("You killed yourself with your own Spell of Iceblast...");
//            }
//        }
//    }
//    @Override
//    protected void fx(int cell, Callback callback) {
//        MagicMissile.coldLight(2, curUser.sprite.parent, curUser.pos, cell, callback);
//        Sample.INSTANCE.play(Assets.SND_ZAP);
//    }
    @Override
    public String desc() {
        return "This spell calls upon the power of ice to destroy your enemies.";
