...
public class Quests extends Image {
...
private int test = 0;
	...
	public Quests() {
		super(Effects.get(Effects.Type.NEW_QUEST));
		origin.set(width / 2, height / 2);
	}

	public Quests(Effects.Type type) {
...
//			Quests s = (Quests) ch.sprite.parent.recycle(Quests.class);
