...
public class SpellOfFirestorm extends Spell {
    {
        name = "Spell of Firestorm";
        //mp_cost = 1;
        image = ItemSpriteSheet.BONE; //SPELL_FIRE3
        //minlevel = 1;
...
//        MagicMissile.fire(6, curUser.sprite.parent, curUser.pos, cell, callback);
