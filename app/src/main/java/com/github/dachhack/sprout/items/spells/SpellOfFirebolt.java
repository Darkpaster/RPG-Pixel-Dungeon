...
public class SpellOfFirebolt extends Spell {
    {
        name = "Spell of Firebolt";
        mp_cost = 1;
        image = ItemSpriteSheet.BONE; //SPELL_FIRE1
        //minlevel = 1;
...
//        if (ch != null) {
//
//            int damage= Random.Int(level, level * level );
...
//        MagicMissile.fire(1, curUser.sprite.parent, curUser.pos, cell, callback);
