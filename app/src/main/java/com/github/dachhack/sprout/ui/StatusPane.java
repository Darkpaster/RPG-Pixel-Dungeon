...
public class StatusPane extends Component {
	...
	protected void createChildren() {
		...
		rage = new Image(Assets.RAGE_BAR);
		energy = new Image(Assets.ENERGY_BAR);

		switch (Dungeon.hero.heroClass){
			case WARRIOR: add(rage); break;
			case ROGUE: add(energy); break;
			case HUNTRESS: add(energy); break;
			case MAGE: add(mp); break;
		}
	...
	protected void layout() {
		...
		mp.x = rage.x = energy.x = 30;
		mp.y = rage.y = energy.y = 10;
	...
	public void update() {
		...
		mp.scale.x = magic;
		float ragee = (float) Dungeon.hero.rage / Dungeon.hero.rageTotal;
		mp.scale.x = magic;
		float energyy = (float) Dungeon.hero.energy / Dungeon.hero.energyTotal;
		mp.scale.x = magic;
		rage.scale.x = ragee;
		energy.scale.x = energyy;
