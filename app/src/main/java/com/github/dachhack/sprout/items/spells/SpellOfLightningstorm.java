...
public class SpellOfLightningstorm extends Spell {
    {
        name = "Spell of Lightning Storm";
//        mp_cost = 1;
//        image = ItemSpriteSheet.SPELL_LIT3;
//        minlevel = 1;
...
//                GLog.n("You killed yourself with your own Spell of Lightning Storm...");
//            }
//        }
//    }
//    @Override
...
//
//            affected.clear();
//            int lvl = Math.round(curUser.magicLevel/3);
...
//    }
    @Override
    public String desc() {
        return "This spell calls upon powerful storms of lightning to destroy you enemies.";
